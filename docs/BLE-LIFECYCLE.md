...
**Still not full Phase A:** only **A11** real-hardware validation remains (see also `skills/xbloom-studio-brew/references/hardware-validation.md` H00–H08). Code/tests for A1–A10 are complete on `codex/roadmap-completion` / core v1.3.0.
