...
A portable Agent Skill for designing bean-specific xBloom Studio recipes and controlling the
machine through guarded local Bluetooth LE.
...
> a machine that dispenses near-boiling water. Recipe loading is the default; remote start requires
> explicit deployment and per-brew safety gates.
...
The current suite contains 112 passing tests and 4 hardware/platform skips.
